...
def health_check():
    ...
    return jsonify({"status": "ok", "bot": "AgentX", "time": datetime.utcnow().isoformat()})
...
def run_bot():
    ...
    try:
        ...
        loop.run_until_complete(application.start_polling(drop_pending_updates=True))
